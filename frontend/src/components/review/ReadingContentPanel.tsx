// src/components/review/ReadingContentPanel.tsx
'use client';
...
import { FileText, MessageSquare, Check, ChevronDown, ChevronUp } from 'lucide-react';
...
export function ReadingContentPanel({ content }: ReadingContentPanelProps) {
