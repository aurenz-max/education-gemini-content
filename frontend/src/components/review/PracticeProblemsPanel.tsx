// src/components/review/PracticeProblemsPanel.tsx - Complete with Revision Support
'use client';
...
import { BookOpen, Plus, Check, ChevronDown, MessageSquare, Clock, Target, Lightbulb, RotateCcw } from 'lucide-react';
...
export function PracticeProblemsPanel({ 
  content, 
  packageId, 
  subject, 
  unit, 
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                ...
                <div className="text-center">
                  <div className="font-semibold text-orange-900">
                    {content.problems ? 
                      Math.round(content.problems.reduce((sum, p) => sum + (p.difficulty || 0), 0) / content.problems.length) 
                      : 0}/10
                  </div>
                  ...
                  >
                    <CollapsibleTrigger asChild>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <Badge className={getDifficultyColor(problem.difficulty || 0)}>
                            {getDifficultyLabel(problem.difficulty || 0)}
                          </Badge>
                            ...
                            <div className="bg-gray-100 rounded p-3">
                              ...
                              <div className="grid grid-cols-2 gap-2 text-xs">
                                ...
                                <div>
                                  ...
                                  <span className="ml-1 font-medium">{problem.difficulty || 0}/10</span>
                                </div>
                              </div>
                            </div>
                          )}
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">
                    {content.problems && content.problems.length > 0 ? 
                      (content.problems.reduce((sum, p) => sum + (p.difficulty || 0), 0) / content.problems.length).toFixed(1)
                      : 0}/10
                  </span>
                </div>
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    {['Easy', 'Medium', 'Hard'].map(level => {
                      const count = content.problems!.filter(p => {
                        ...
                        if (level === 'Easy') return difficulty <= 3;
                        if (level === 'Medium') return difficulty > 3 && difficulty <= 6;
                        return difficulty > 6;
                      }).length;
