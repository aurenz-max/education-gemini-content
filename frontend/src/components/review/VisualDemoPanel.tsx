// src/components/review/VisualDemoPanel.tsx
'use client';
...
import { Eye, Play, Code, Check, ChevronDown, MessageSquare, ExternalLink } from 'lucide-react';
...
export function VisualDemoPanel({ content }: VisualDemoPanelProps) {
